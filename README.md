...
В этом репозитории - мой, так сказать, "портфолио" - мои наиболее интересные, на мой взгляд проекты, в которых отражены особености моего "творческого метода". Ну и некоторые учебные проекты из числа домашних заданий на курсах промпт-инжениринга от "Университета Зерокодинга", которые я по-своему переосмыслил.
